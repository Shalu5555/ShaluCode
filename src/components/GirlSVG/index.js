...
const GirlSVG = () => {
    useEffect(() => {
        ...
        meTl
            ...
            .to(".eye-right , .eye-left", { duration: 0.01, opacity: 1 })
            .to(".eye-right-2 , .eye-left-2", { duration: 0.01, opacity: 0 });
        ...
        // ================= FACE MOVEMENT =================
        let xPosition, yPosition, storedX = 0, storedY = 0;
        ...
        function animateFace() {
            if (!xPosition) return;
            if (storedX === xPosition && storedY === yPosition) return;
            ...
            gsap.to([dom.eyebrowLeft, dom.eyebrowRight].filter(Boolean), { yPercent: y * 2.5 });
    ...
    return (
        <div className="flex items-center justify-center min-h-screen overflow-hidden">
            <svg viewBox="0 10 211.73 180" strokeLinecap="round" strokeLinejoin="round" className="w-[600px] max-w-[90vw]"            >
                <defs>
