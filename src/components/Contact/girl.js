...
const Bubble = ({ text }) => {
    return (
        <motion.div
            ...
            className="absolute right-[8px] lg:right-[7rem] xl:right-[50%] 2xl:right-[10%] top-[36rem] lg:top-[20rem] 2xl:top-[50%] z-50 bg-[#ffffff8a] text-white font-semibold px-2 lg:px-3 py-2 rounded-2xl shadow-lg border border-gray-200 max-w-[200px] text-[9px] lg:text-xs"
        >
            <div className="absolute left-[-0.5rem] top-1.5 lg:top-2 w-0 h-0 border-t-8 border-b-8 border-r-8 border-t-transparent border-b-transparent border-r-[#ffffff8a] drop-shadow" />
            {text}
        </motion.div>
    );
};
...
const Girl = () => {
    ...
    useEffect(() => {
        const handleMouseMove = (e) => {
            // normalize cursor relative to window
            const x = (e.clientX / window.innerWidth - 0.5) * 6; // max ±3
    ...
    // Mouth open/close every 5 seconds
    useEffect(() => {
        const interval = setInterval(() => {
            setMouthOpen(true);   // open
            // Close after 1s
        ...
        <>
            ...
            >
                <defs>
                    ...
                    >
                        <stop offset={0} stopColor="#7e5582" />
                        <stop offset="0.01" stopColor="#7e5582" />
                ...
                <g clipPath="url(#clip-path)">
                    <g id="me" className="girl-popup" data-name="me">
                        <g id="body">
                            <path
                                id="shadow"
                                className="shadow"
                                ...
                                <g id="inner-face">
                                    ...
                                    <g className="mouth-g">
                                        <g clipPath="url(#clip-path-2)">
                                            <g id="mouth" className="mouth" opacity={mouthOpen ? 1 : 0}>
                                                <ellipse
                                                    cx="104.95"
                                                    cy="106.66"
                                                    rx="9.92"
                                    ...
                                    <g id="eyes">
                                        {/* <circle cx="92" cy="87" r="6" fill="#fff" />
                                    <circle
                                        cx="92"
                                        cy="87"
                                        r="3"
                                    ...
                                    <circle cx="116" cy="87" r="6" fill="#fff" />
                                    <circle
                                        cx="116"
                                        cy="87"
                                        r="3"
                                    ...
                                    /> */}
                                        ...
                                        <ellipse
                                            ...
                                            cy="87"
                                            rx="3"
                                            ry={blinking ? 0.3 : 3}   // 👈 shrink vertically
                                            fill="#2b343b"
                                            transform={`translate(${eyePos.x},${eyePos.y})`}
                                        />
